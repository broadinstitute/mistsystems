...
class Webhook:
    ...
    def cli(self):
        ...
        if self.enabled == False:
            logging.info("Webhook will be disabled.")
        resp = False
        while not resp:
                ...
                try:
                    ...
                    for num in val_splitted:
                        ...
                        if resp_num >= 0 and resp_num < len(topics_list):
                            val_list.append(topics_list[resp_num])                        
                        else:
    ...
    def set_name(self, value):
        if value != "":
            ...
            logging.error("You must enter a name.")
            return False
    ...
    def set_type(self, value):        
        if value in types_list:            
            ...
            logging.error("Value %s is not accepted. Must be \"http-post\", \"splunk\", \"google-pubsub\" or \"aws-sns\"." %value)
            return False
    ...
    def set_url(self, value):
        if str(value).lower().startswith("https://"):            
            ...
            logging.error("Value %s is not accepted. Please enter a valid URL." %value)
            return False
    ...
    def set_secret(self, value):
        if self.type == "http-post":
            ...
            logging.warning("This settings is only used with \"http-post\" webhook types.Please configure the webhook at \"http-post\" first.")
        return True
    ...
    def set_splunk_token(self, value):
        if self.type == "splunk":
            ...
            logging.warning("This settings is only used with \"splunk\" webhook types.Please configure the webhook at \"splunk\" first.")        
        return True         
    ...
    def set_verify_cert(self, value):
        try:
            ...
            logging.error("Value %s is not accepted. Must be \"true\", \"false\", \"0\" or \"1\"." %value)
            return False
    ...
    def set_topics(self, values_list):
        ...
        for value in values_list:
            if value in topics_list:
                ...
                logging.error("%s is not accepted." %value)
        self.topics = val
        return True
